...
class Extinction:
    ...
    def _get_extinction_parameters(self):
        ...
        if isinstance(self.dustmap, Edenhofer2023Query):
            ...
            extinction_data_hb = self._convert_zgr23_to_extinction(zgr23_extinction, 486.1) * A_V_to_A_hb
            ...
            extinction_data_ha = 10 ** (-0.4 * A_KS_to_A_v * A_V_to_A_ha * (self.dustmap.query(self.lbd) * 2.742))
            extinction_data_hb = 10 ** (-0.4 * A_KS_to_A_v * A_V_to_A_hb * (self.dustmap.query(self.lbd) * 2.742))
    ...
    def _convert_zgr23_to_extinction(self, zgr23_extinction, wavelength):
        ...
        extinction = interp_func(wavelength)
